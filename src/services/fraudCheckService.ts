...
import { FraudCheckType, IdentityCheckCredentialJWTClass, JWTClass } from "@govuk-one-login/data-vocab/credentials";
...
const instanceOfIdentityCheckCredential = (
  ...
  return object.vc.type !== undefined && object.vc.type.includes("IdentityCheckCredential");
};
